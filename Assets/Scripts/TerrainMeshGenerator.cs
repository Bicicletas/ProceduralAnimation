...
public class TerrainMeshGenerator : MonoBehaviour
{
    ...
    public void GenerateMap()
    {
        ...
        HeightMapGen heightmapGenerator = new HeightMapGen(meshVariables, heightmapVariables, _gradientColorArray);
        heightmapGenerator.Schedule(meshVariables.TotalVerts, 10000).Complete();
        Maps _maps = heightmapGenerator.ReturnAndDispose();

        MeshGen meshGenerator = new MeshGen(meshVariables, _maps);
...
[BurstCompile]
public struct HeightMapGen : IJobParallelFor
{
    ...
    public HeightMapGen(TerrainMeshVariables mv, TerrainHeightmapVariables hv, NativeArray<Color> grad)
    {
        _meshVariables = mv;
...
[BurstCompile]
public struct MeshGen : IJobParallelFor
{
    ...
    public MeshGen(TerrainMeshVariables mv, Maps m)
    {
        _meshVariables = mv;
